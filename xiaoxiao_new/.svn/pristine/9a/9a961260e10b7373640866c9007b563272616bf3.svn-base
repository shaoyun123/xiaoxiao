				...
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<ol class="breadcrumb navbar-breadcrumb">
							<li>学生管理</li>
							<li class="active"><a href="yuanxiliebiao">院系列表</a></li>
							<li class="active"><a href="chakanzhuanye?yuanxiid=${yuanxi.yuanxiid}">${yuanxi.yuanximingcheng}院系列表</a></li>
							<li>修改专业</li>
						</ol>
						<button type="button"
                	...
                	<div class="row">
                        <div class="col-xs-12">
                            <div class="card" style="background-color:#dfffdf;">
                                <div class="card-body">
                                    <form action="savemodifyzhuanye?id=${zhuanye.daima}" class="form-inline" method="post">
                                    	
                                    	<div class="sub-title">
                                    		<span style="font-weight:bold;">选择院系:</span>
                                    		<select id="yuanxiid" name="yuanxiid">
                                    			
                                    			<c:forEach items="${yuanxis}" var="yuanxi">
                                    				<option value="${yuanxi.yuanxiid}" <c:if test="${yuanxi.yuanxiid==yuanxiid}">selected="selected"</c:if>>${yuanxi.yuanximingcheng}</option>
