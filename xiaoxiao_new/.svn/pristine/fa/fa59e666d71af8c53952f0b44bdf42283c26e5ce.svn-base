	...
	<div class="box-content">
		<form action="" class="form-horizontal" method="post"
			...
			<!--                                     		<label class="control-label">事件地点：</label>
																<div class="controls">
																<input id="didian" name="didian" type="text" size="40"/> 
																</div>-->
			<!--                                     	</div> -->
			<div class="control-group">
				...
				<div class="controls">
					<input id="riqi" name="riqi" type="text" class="Wdate"
						style="height: 25px"
						onclick="WdatePicker({readOnly:true,dateFmt:'yyyy-MM-dd'})" />&emsp;<input
						id="shijian" name="shijian" type="text" class="Wdate"
						style="height: 25px"
