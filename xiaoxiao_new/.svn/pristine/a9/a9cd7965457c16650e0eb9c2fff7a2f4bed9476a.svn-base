			...
			<div class="container-fluid">
				<div class="side-body">
					<div class="page-title">
                        <span class="title">请在下面选择下届人员名单，原职务不变，社长必须选：</span>
                    </div>
					<div class="row">
						<div class="col-xs-12">
							<div class="card">
								<div class="card-body">
									<form action="ssubhjxxwh" method="post">
									<table class="table">
										<thead>
											<tr>
												<th>学号</th>
										...
										<tbody>
											<c:forEach items="${renyuans}" var="renyuan">
												<tr height=65px>
													...
													<td>${renyuan.bumen}</td>
													<td>${renyuan.zhiwu}</td>
													<td><input type="checkbox" name="choice" value="${renyuan.xueshengid }"></td>
												</tr>
											</c:forEach>
											<tr>
												<td></td>
												...
												<td></td>
												<td></td>
												<td><input type="checkbox" name="mmAll" onclick="checkAll(this, 'choice')">全选</td>
											</tr>
										</tbody>
									</table>
