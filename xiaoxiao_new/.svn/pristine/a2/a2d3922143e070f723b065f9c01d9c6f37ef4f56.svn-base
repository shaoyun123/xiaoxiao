							...
							<div class="card">
								<div class="card-body">
									...
									<div align="center">
										<ul class="pagination">
											<c:if test="${page >1}">
												<li><a href="qingjiayishangjiao_fdy">首页</a></li>
											</c:if>
											<c:if test="${page > 1}">
												<li><a href="qingjiayishangjiao_fdy?page=${page-1}">上一页</a></li>
											</c:if>
											<li><a href="#">第${page}页</a></li>
											<c:if test="${page < pages}">
												<li><a href="qingjiayishangjiao_fdy?page=${page+1}">下一页</a></li>
											</c:if>
											<c:if test="${page < pages}">
												<li><a href="qingjiayishangjiao_fdy?page=${pages}">尾页</a></li>
											</c:if>
										</ul>
									</div>
								</div>
