...
// 			window.location.href="chaxundanmenkecheng?id="+items[0];
		$.post("chaxundanmenkecheng_stu",{"id":items[0],"riqi":items[3],"zhouci":items[2],"kaishijieci":items[4],"jieshujieci":items[5],"jiaoshiid":items[6]},function(data){
			var html="";
		...
		window.location.href="richeng_huodong_stu?id="+items[0]+"&zhuangtai="+zhuangtai+"&qufen=1";

		} else if(items[1] == "3"){  // 备忘录
			window.location.href="mybeiwanglu?id="+items[0]+"&qufen=1";
		} 
	}
