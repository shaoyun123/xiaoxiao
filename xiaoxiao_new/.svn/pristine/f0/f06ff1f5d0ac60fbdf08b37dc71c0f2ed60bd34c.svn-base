				...
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<ol class="breadcrumb navbar-breadcrumb">
							<li>思想汇报</li>
							<li class="active"><a href="jiaoliuneirong">交流列表</a></li>
							<li class="active">交流内容</li>
						</ol>
						<button type="button"
			...
			<div class="container-fluid">
				<div class="side-body">
					<div class="page-title">
						<span class="title">${jiaoliumingcheng}</span>
						<div class="description"></div>
					</div>
					<div class="col-xs-12">
						<div class="card" style="background-color:#ffffff;">
						<div class="card-body">
							<h4 style="font-weight:bold;">学生汇报:</h4>
							<hr>
							<div style="width:85%;margin-left:20px;"><span style="font-family:'楷体';font-size:17px;">${xueshengshangchuan}</span></div>
							<hr>
							<h4 style="font-weight:bold;">导员评价:</h4>
							<hr>
							<div style="width:85%;margin-left:20px;"><span style="font-family:'楷体';font-size:17px;">${fudaoyuanshenhe}</span></div>
						</div>
						<div style="float:right;margin-right:20px;"><a href="jiaoliuneirong"><button>关闭</button></a></div>
						<br><br>
						</div>
					</div>
				</div>
