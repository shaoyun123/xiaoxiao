							...
							<div class="card">
								<div class="card-body">
											...
											<c:forEach items="${jiatiao}" var="qingjiatiao">
												<tr height=65px>
													...
													<c:choose>
														...
														<c:when test="${qingjiatiao.zhuangtai ==2}">
															<td><a href="cfm?id=${qingjiatiao.qingjiaid}"
																onclick="return cfm()"><input type="button"
									...
									<div align="center">
										<ul class="pagination">
											<c:if test="${page >1}">
												<li><a href="myApplication">首页</a></li>
											</c:if>
											<c:if test="${page > 1}">
												<li><a href="myApplication?page=${page-1}">上一页</a></li>
											</c:if>
											<li><a href="#">第${page}页</a></li>
											<c:if test="${page < pages}">
												<li><a href="myApplication?page=${page+1}">下一页</a></li>
											</c:if>
											<c:if test="${page < pages}">
												<li><a href="myApplication?page=${pages}">尾页</a></li>
											</c:if>
										</ul>
									</div>
								</div>
