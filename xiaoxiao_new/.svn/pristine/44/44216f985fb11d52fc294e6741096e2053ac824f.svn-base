...
<body class="flat-blue">
	<div class="app-container">
		<div class="row content-container">
			...
			<div class="container-fluid">
				<div class="side-body">
					<c:set value="${jibenxinxi}" var="jibenxinxi" />
					<c:set value="${xinxi }" var= "xinxi"/>
					<div class="card">
						<div class="card-header">
							<div class="card-title">
								<div class="title">学生组织名称：${jibenxinxi.mingcheng}&emsp;&emsp;指导教师：${jibenxinxi.zhidaojiaoshi }</div>
							</div>
						</div>
						<div class="card-body">
							<div class="text-indent">
								<h3>指导人：${xinxi.zhidaoren}&emsp;&emsp;负责人：${xinxi.fuzeren }&emsp;&emsp;人数：${xinxi.renshu }人</h3>
								<h3>介绍：</h3>
								<div class="text-indent" style="width:80%">
									<font size="4px">${jibenxinxi.jianjie }</font>
								</div>
							</div>
