			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-top">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						<a href="saddbumen?id=${shetuanxinxiid}" ><span title="新增部门" class="glyphicon glyphicon-plus" style="padding-top:20px;padding-left:20px;font-size:18px"></span></a>
						<button type="button"
				...
				if(cfm()){
					...
					$.ajax({
						...
						success:function(data)
						{
							if(data=="success"){
								alert("成功！")
								window.location.href="szsbm?id=${shetuanxinxiid}";
							}
							else{
								alert("fail")
							}
