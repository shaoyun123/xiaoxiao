...
var path = '<%=request.getContextPath()%>';
	...
	function fanhuichongzai() {
		//$('#calendarHtml').html('');
		$('#calendarHtml').load(
				path + '/static/richeng/wodericheng_fdy.jsp?t='
					...
					<li class="dropdown" style="display: inline; margin-left: 30px;"><a
						...
						<ul class="dropdown-menu" style="position: absolute;">
							...
							<li><a href="JavaScript:void(0);"
								onclick="toContentPage('addhuodong_fdy?qufen=1')"><i
									class="icon-plus" style="margin-left: 2px;"></i> 新增活动</a></li>
							<li><a href="JavaScript:void(0);"
								onclick="toContentPage('newhuodong_fdy')"><i
									class="icon-comment" style="margin-left: 2px;"></i> 待确认活动</a></li>
							<li><a href="JavaScript:void(0);"
								onclick="toContentPage('myhuodong_fdy')"><i
