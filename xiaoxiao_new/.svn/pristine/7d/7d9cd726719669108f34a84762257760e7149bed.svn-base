...
<div class="row-fluid">
	<div class="box span12">
		<div class="box-header">
			<h2>
				<i class="icon-align-justify"></i><span class="break"></span>修改德育考评表
			</h2>
		</div>
		<div class="box-content">
			<form action="" name="form" class="form-horizontal" method="post" id="forms">
				<c:set value="${tianxietiaomu[0].fanganid}" var="fanganid" />
				<input type="hidden" id="fanganid" name="fanganid"
					value="${fanganid}"> 
				<input type="hidden" id="deyufenid" name="deyufenid" value="${id}">
				<input type="hidden" id="xuenian" value="${xuenian}">
				<input type="hidden" id="xueqi" value="${xueqi}">
				<input type="hidden" id="yuanxi" value="${yuanxi}">
				<input type="hidden" id="zhuanye" value="${zhuanye}">
				<input type="hidden" id="nianfen" value="${nianfen}">
				<input type="hidden" id="banji" value="${banji}">
				<table class="table">
	...
	function save(){
		...
		$.ajax({
			...
			success : function(data) {
				...
				toContentPage('deyuchengji_gly?xuenian='+xuenian+'&xueqi='+xueqi+'&banji='+banji+'&yuanxi='+yuanxi+'&zhuanye='+zhuanye+'&nianfen='+nianfen);
			},
			error : function() {
				alert("超时!")
			}
