...
var thisDate= new Date();
	...
	function fanhuichongzai(){
		//$('#calendarHtml').html('');
		$('#calendarHtml').load(path+'/static/richeng/wodericheng_shuji.jsp?t='+new Date().getTime(),function(e){
		});
	}
	...
	<div class="box span12">
		<div class="navbar-inner">
			...
			<ul class="nav pull-left" style="display: inline;">
			 ...
			 class="btn account dropdown-toggle" data-toggle="dropdown" href="#">
					日程管理
					</a>
					<ul class="dropdown-menu" style="position: absolute;">
						...
						<li><a href="JavaScript:void(0);" onclick="toContentPage('addhuodong_sj')" ><i class="icon-plus" style="margin-left: 2px;"></i> 新增活动</a></li>
						<li><a href="JavaScript:void(0);" onclick="toContentPage('newhuodong_sj')"><i class="icon-comment" style="margin-left: 2px;"></i> 待确认活动</a></li>
						<li><a href="JavaScript:void(0);" onclick="toContentPage('myhuodong_sj')"><i class="icon-align-justify" style="margin-left: 2px;"></i> 我的活动</a></li>
					</ul>
				</li>
				<!-- end: User Dropdown -->
			</ul>
		...
		<div class="box-content">
					<form id="riqi" name="form" onsubmit="return search()" action="chaxunricheng_sj" method="post" 
