		...
		<div class="row content-container">
						...
						<c:set value = "${xueshengzuzhi }" var="xueshengzuzhi" />
							<form action="" method="post">
								...
								<div
									...
									<font size=5px> 学生组织：${xueshengzuzhi.mingcheng}</font>
								</div>
								<div
									style="width: 40%; border-top: 1px solid #000000;border-right: 1px solid #000000; text-align: center; float: left;">
									<font size=5px>金额：</font><input name="jine" id="jine"
										type="number" style="width: 150px;"/>元
								</div>
								<div
									style="width: 80%; border: 1px solid #000000;float: left;">
									<font size=5px>&emsp;用途：</font>
									<br>
									<textarea  name="yongtu" id="yongtu"  class="form-control" style="width:80%;height:300px;margin-left: 50px;resize:none;"></textarea>
									<br>
								</div>
								<div style="width:80%">
			...
			function severCheck(){
				if(check()){
					...
					var code = id+",zytech,"+jine+",zytech,"+yongtu;
					$.ajax({
						type: "POST",
						url: 'subxsqjf',
				    	data:{CODE:code},
