...
public interface YiJianXiangMapper {
    ...
    int insertSelective(YiJianXiang record);
    ...
    int updateByPrimaryKeySelective(YiJianXiang record);
    ...
    int updatechuliByPrimaryKey(YiJianXiang record);//更新辅导员处理，包括处理人，评论量，可见人范围，可见学生id，可见教师id
    
    List<YiJianXiang> getAllByXSandBQandNM(Map<String, String> map);//根据可见学生ID、标签、匿名状态、提交状态、公布状态查找
    
    List<YiJianXiang> getAllByXSandBQandBJandNM(Map<String, String> map);//根据可见学生ID、标签、班级、匿名状态、提交状态、公布状态查找
    
    List<YiJianXiang> getAllByXSandBQandBJandNMandpage(Map<String, String> map);
    
    List<YiJianXiang> getAllByXSandBQandZYandNM(Map<String, String> map);//根据可见学生ID、标签、专业、匿名状态、提交状态、公布状态查找
    
    List<YiJianXiang> getAllByXSandBQandZYandNMandpage(Map<String, String> map);
    
    List<YiJianXiang> getAllByXSandBQandYXandNM(Map<String, String> map);//根据可见学生ID、标签、院系、匿名状态、提交状态、公布状态查找
    
    List<YiJianXiang> getAllByXSandBQandYXandNMandpage(Map<String, String> map);
    
    List<YiJianXiang> getAllByXSandBQandNMandpage(Map<String, String> map);//根据可见学生ID、标签、匿名状态、提交状态、公布状态查找
    
    List<YiJianXiang> getAllByJSandBQandNM(Map<String, String> map);//根据可见教师ID、标签、匿名状态、提交状态、公布状态查找
