...
public interface BeiWLMapper {
    int deleteByPrimaryKey(Integer id);

    int insert(Map<String, String> map);//自己备忘
    ...
    int updateByPrimaryKey(BeiWL record);//修改自己的备忘
	...
	List<Map<String, Object>> getBeiWLHuiZhiByBeiWLIDAndRenIDAndRenLeiXing(Map<String, String> map);
