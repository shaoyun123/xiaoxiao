								...
								<c:if
									...
									<li class="panel panel-default dropdown"><a
										data-toggle="collapse" href="#dropdown-${UserMenu.id}"> <span
											class="icon fa fa-desktop"></span><span class="title">${UserMenu.menuname}</span>
									</a>
			...
			<div class="container-fluid">
				<div class="side-body">
					<div class="row">
						<div class="col-md-12">
							<div class = "title">
								<c:if test="${not empty xueshengzuzhi }">
									<h3>${xueshengzuzhi.mingcheng }</h3>
								</c:if>
								<c:if test="${not empty shetuan }">
									<h2 style="text-align:center;">${shetuan.mingcheng }${huodong.huodongmingcheng }</h2>
								</c:if>
							</div>
							<div class="description" style="text-align:center;">
								<span>发布时间：${huodong.fabushijian }</span>
							</div>
							<hr>
							<div class="card">
								...
								<div class="card-body" style="text-indent:30px;">
									<p style="font-size:20px;">
										${huodong.huodongxiangqing }
									</p>
								</div>
								<div class="page-title" style="margin-left:50px;">
								...
								<div class="card-body" style="text-indent:30px;">
									<p style="font-size:20px;">
										${huodong.huodongliucheng }
									</p>
								</div>
								<hr>
								<c:if test="${not empty huodong.huodongjilu }">
									<div class="page-title" style="margin-left:50px;">
