...
var path = '<%=request.getContextPath()%>';
	...
	function fanhuichongzai() {
		//$('#calendarHtml').html('');
		$('#calendarHtml').load(
				path + '/static/richeng/wodericheng_gly.jsp?t='
...
<div class="box span12">
				...
				<li class="dropdown" style="display: inline; margin-left: 30px;"><a
					...
					<ul class="dropdown-menu">
						...
						<li><a href="JavaScript:void(0);"
							onclick="toContentPage('addhuodong_gly')"><i
								class="icon-plus" style="margin-left: 2px;"></i> 新增活动</a></li>
						<li><a href="JavaScript:void(0);"
							onclick="toContentPage('newhuodong_gly')"><i
								class="icon-comment" style="margin-left: 2px;"></i> 待确认活动</a></li>
						<li><a href="JavaScript:void(0);"
							onclick="toContentPage('myhuodong_gly')"><i
	...
	<div class="box-content">
		<form id="riqi" name="form" onsubmit="return search()"
			action="chaxunricheng_gly" method="post" class="form-horizontal"
