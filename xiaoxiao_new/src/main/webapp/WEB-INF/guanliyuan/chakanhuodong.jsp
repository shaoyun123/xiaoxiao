			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-top">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="addhuodong_gly" ><span title="新增活动" class="glyphicon glyphicon-plus" style="padding-top:20px;font-size:18px"></span></a>
					</div>
								...
								<table class="table table-striped">
									...
									<tbody>
											<tr>
												...
												<td>
													<c:if test="${huodong.zhuangtai==0}"><a  href="canyuhuodong_gly?id=${huodong.huodongid}"><input type="button" value="参与"></a></c:if>
													<c:if test="${huodong.zhuangtai==1}">——</c:if>
													<c:if test="${huodong.zhuangtai==2}">——</c:if>
												</td>
												<td>
													<a href="chakancanyuren_gly?id=${huodong.huodongid}"><input type="button" value="查看"></a>
												</td>
												<td>
													<c:if test="${huodong.tianjiarenid==guanliyuanid}">
													   <a href="xiugaihuodong_gly?id=${huodong.huodongid}"><input type="button" value="修改"></a>
													</c:if>
												</td>
												<td>
												<c:if test="${huodong.zhuangtai==0}"><a href="delhuodong_gly?id=${huodong.huodongid}"><input type="button" value="拒绝"></a></c:if>
													<c:if test="${huodong.zhuangtai==1}"><a href="delhuodong_gly?id=${huodong.huodongid}"><input type="button" value="拒绝"></a></c:if>
													<c:if test="${huodong.zhuangtai==2}">——</c:if>
												</td>
