			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-top">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="addhuodong" ><span title="新增活动" class="glyphicon glyphicon-plus" style="padding-top:20px;font-size:18px"></span></a>
					</div>
								...
								<table class="table table-striped">
									...
									<tbody>
											<tr>
												...
												<td>
													<c:choose>
														<c:when test="${huodong.tianjiaren==xueshengid}"><a href="xiugaihuodong?${huodong.huodongid}"><input type="button" class="btn btn-default" value="修改"></a></c:when>
												...
												<td>
													<c:if test="${huodong.zhuangtai==0}"><a  href="canyuhuodong_fdy?id=${huodong.huodongid}"><input type="button" value="参与"></a></c:if>
													<c:if test="${huodong.zhuangtai==1}">——</c:if>
													<c:if test="${huodong.zhuangtai==2}">——</c:if>
												</td>
												<td>
													<a href="chakancanyuren_huodong?id=${huodong.huodongid}"><input type="button" class="btn btn-default" value="查看"></a>
												</td>
												<td>
												
												<c:if test="${huodong.zhuangtai==0}"><a href="javascript:delhuodong(${huodong.huodongid},${qufen}"><input type="button" class="btn btn-default" value="拒绝"></a></c:if>
													<c:if test="${huodong.zhuangtai==1}"><a href="javascript:delhuodong(${huodong.huodongid},${qufen})"><input type="button" class="btn btn-default" value="拒绝"></a></c:if>
													<c:if test="${huodong.zhuangtai==2}">——</c:if>
												</td>
		...
		<div>
			...
			<script type="text/javascript">
				...
				function delhuodong(id,qufen){
					...
					$.post("tijiaoliyou",{"id":id,"liyou":msg,"qufen":qufen},function(data){
						if(data.success){
							alert("拒绝成功！！");
							if(data.qufen==1){
