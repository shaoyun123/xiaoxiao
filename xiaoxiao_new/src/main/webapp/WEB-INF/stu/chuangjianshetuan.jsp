...
<!-- Main Content -->
		...
		<div class="box-header">
			<h2><i class="icon-align-justify"></i><span class="break"></span>创建社团申请</h2>
		</div>
					<div class="box-content"  style="height: 1000px;">
							<form action="" method="post">
								...
								<div
									...
									<font size=5px style="margin-left: -140px;">联系电话：</font><input name="dianhua" id="dianhua"
										type="tel" style="width: 150px;"/>
									
								</div>
								<div
									style="line-height:36px;width: 40%; border: 1px solid #000000;  float: left;">
									<font size=5px>&emsp;社团名称：</font><input name="mingcheng" id="mingcheng"
										type="text" style="width: 60%;height:30px;margin-bottom:5px;"/>
									
								</div>
								<div
									style="line-height:46px;width: 40%; height: 46px;border-top: 1px solid #000000;border-bottom: 1px solid #000000;border-right: 1px solid #000000; text-align: center; float: left;">
									<font size=5px>指导教师：</font>
									<select id="jiaoshi" name="jiaoshi" style="width: 60%;height:30px;margin-bottom:5px;">
