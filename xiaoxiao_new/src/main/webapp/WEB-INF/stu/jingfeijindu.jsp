									...
									<c:choose>
										...
										<tbody>
											<c:forEach items="${jingfei}" var="jingfei">
												<tr height=65px>
													<th scope="row">${jingfei.jinfeiid}</th>
													<td>${jingfei.jine}</td>
													<td>${jingfei.yongtu}</td>
													<td>${jingfei.shenqingshijian}</td>
													<c:choose>
													...
													<td>${jingfei.pizhunren}</td>
													<td>${jingfei.pizhunshijian}</td>
													<td></td>
												</tr>
											</c:forEach>
										</tbody>
