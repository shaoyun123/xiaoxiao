		...
		<div class="row content-container">
			...
			<div class="container-fluid">
				<div class="side-body">
							...
							<div class="card">
								<div class="card-body">
									<form id="chaxunbumenrenyuan" name="form"
										onsubmit="return searchResult()" action="szdbz?id=${shetuanxinxiid}"
					...
					<input type="hidden" name="shetuanxinxiid" id="shetuanxinxiid" value="${shetuanxinxiid}">
									<table class="table">
										<thead>
											<tr>
												<th>学号</th>
				...
				if(cfm(option.text())){
					...
					$.ajax({
						...
						success:function(data)
						{
							if(data=="success"){
								alert("成功！")
								window.location.href="szdbz?id=${shetuanxinxiid}";
							}
							else{
								alert("fail")
							}
