						...
						<div class="card-body">
							<form action="" method="post">
								<div
									...
									<font size=5px>社团名称：${shetuanjibenxinxi.mingcheng}</font>
								</div>
								<input type="hidden" id = "id" name="id" value="${shetuanjibenxinxi.shetuanid }">
								<div
									style="width: 30%; border-top: 1px solid #000000;border-right: 1px solid #000000; text-align: center; float: left;">
									<font size=5px>星级：${shetuanjibenxinxi.xingji }星级</font>
								</div>
								<div
									style="width: 60%; border-top: 1px solid #000000;border-right: 1px solid #000000;border-left: 1px solid #000000; border-bottom: 1px solid #000000;float: left;">
									<font size=5px>&emsp;社团主页：</font><input name="url" id="url"
										type="text" style="width: 300px;" value="${shetuanjibenxinxi.shetuanjieshaourl }"/>
								</div>
								<div
									style="width: 60%; border-left: 1px solid #000000;border-right: 1px solid #000000;border-bottom: 1px solid #000000; float: left;">
									<font size=5px>&emsp;社团介绍：</font>
									<br>
									<textarea  name="jieshao" id="jieshao"  class="form-control" style="width:80%;height:300px;margin-left: 50px;resize:none;">${shetuanjibenxinxi.shetuanjieshao }</textarea>
									<br>
								</div>
								<div style="width:60%">
