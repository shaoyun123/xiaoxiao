				...
				<div class="side-body">
					<div class="card">
						<div class="card-header">
							<c:set value="${shetuanxinxi}" var="shetuan" />
						...
						<div class="card-body">
							<form action="tijiaobaoming" method="post">
								<input type="hidden" name="leixing" id="leixing" value="1">
								<input type="hidden" name="shetuanxinxiid" id="shetuanxinxiid"
									value="${shetuan.shetuanxinxiid}">
								<div
								...
								<div
									...
									<font size=5px>出生日期：</font><input name="chushengriqi"
										id="chushengriqi" type="date" style="width: 200px" />

								</div>
								<c:if test="${not empty shetuan.bumen }">
									<div
										style="width: 80%; border-left: 1px solid #000000; border-right: 1px solid #000000; border-bottom: 1px solid #000000; float: left;">
										<font size=5px>&emsp;报名部门：</font> <br>
										&emsp;&emsp;&emsp;&emsp;
										<c:forEach items="${shetuan.bumen }" var="bumen">
											&emsp;&emsp;
											<input name="bumen" id="bumen" type="radio"
												value="${bumen.shetuanbumenxinxiid}"
												style="margin-left: 50px;" />
											<font size=5px>${bumen.mingcheng}</font>
										</c:forEach>
										<br>
									</div>
								</c:if>
								<div
									...
									<font size=5px>&emsp;爱好特长：</font> <br>
									<textarea name="aihaotechang" id="aihaotechang"
										class="form-control"
										style="width: 80%; height: 250px; margin-left: 50px; resize: none;"></textarea>
									<br>
								</div>
								<div style="width: 80%; border: 1px solid #000000; float: left;">
									<font size=5px>&emsp;自我介绍：</font> <br>
									<textarea name="ziwojieshao" id="ziwojieshao"
										class="form-control"
										style="width: 80%; height: 250px; margin-left: 50px; resize: none;"></textarea>
									<br>
								</div>
								<div style="width: 80%">
									<span class="pull-right"><input type="submit"
										class="flip-link btn btn-info" style="margin-bottom:30px;" value="提交"
