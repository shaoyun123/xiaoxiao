		...
		<div class="row content-container">
			...
			<div class="container-fluid">
				<div class="side-body">
					<div class="card">
						...
						<div class="card-body">
						<c:set value = "${xueshengzuzhi }" var="xueshengzuzhi" />
							<form action="" method="post">
								<input type="hidden" value="${xueshengzuzhi.xueshengzuzhixinxiid}" name ="id" id="id">
								<div
									...
									<font size=5px>社团：${xueshengzuzhi.mingcheng}</font>
								</div>
								<div
									style="width: 40%; border-top: 1px solid #000000;border-right: 1px solid #000000; text-align: center; float: left;">
									<font size=5px>部门名称：</font><input name="mingcheng" id="mingcheng"
										type="text" style="width: 150px;"/>
								</div>
								<div
									style="width: 80%; border: 1px solid #000000;float: left;">
									<font size=5px>&emsp;职责：</font>
									<br>
									<textarea  name="zhize" id="zhize"  class="form-control" style="width:80%;height:300px;margin-left: 50px;resize:none;"></textarea>
									<br>
								</div>
								<div style="width:80%">
			...
			function severCheck(){
				if(check()){
					...
					var zhize = $("#zhize").val();
					var code = xueshengzuzhixinxiid+",zytech,"+mingcheng+",zytech,"+zhize;
					$.ajax({
						type: "POST",
						url: 'subxaddbumen',
				    	data:{CODE:code},
						...
						success:function(data)
						{
							if(data=="success"){
								alert("提交成功！")
								window.location.href="xzsbm?id=${xueshengzuzhi.xueshengzuzhixinxiid}";
							}
							else if(data=="same"){
								alert("已有同名部门！")
							}
