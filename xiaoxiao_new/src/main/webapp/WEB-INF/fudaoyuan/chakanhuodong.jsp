								...
								<table class="table table-striped">
									...
									<tbody>
											<tr>
												...
												<td>
													<c:choose>
														<c:when test="${huodong.tianjiaren==fudaoyuanid}"><a href="xiugaihuodong_fdy?id=${huodong.huodongid}"><input type="button" class="btn btn-default" value="修改"></a></c:when>
												...
												<td>
													<a href="chakancanyuren_fdy?id=${huodong.huodongid}"><input type="button" class="btn btn-default" value="查看"></a>
												</td>
												<td>
												
												<c:if test="${huodong.zhuangtai==0}"><a href="delhuodong_fdy?id=${huodong.huodongid}"><input type="button" class="btn btn-default" value="拒绝"></a></c:if>
													<c:if test="${huodong.zhuangtai==1}"><a href="delhuodong_fdy?id=${huodong.huodongid}"><input type="button" class="btn btn-default" value="拒绝"></a></c:if>
													<c:if test="${huodong.zhuangtai==2}">——</c:if>
												</td>
