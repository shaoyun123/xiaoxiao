...
<div class="row-fluid">
	<div class="box span12">
		<div class="box-header">
			<h2>
				<i class="icon-align-justify"></i><span class="break"></span>意见处理
			</h2>
		</div>
			...
			<div class="card" style="background-color: #ffffff;">
				...
				<div style="width: 88%; margin-left: 40px">
					<form action="" method="post" id="form">
						...
						<br> <span class="pull-right" style="display: inline;"> <input type="radio"
							id="bugongbu" name="isgongbu" checked value="0" style="display: inline;"><label
							style="color: red;display: inline;" for="bugongbu">不公布</label> <input style="display: inline;" type="radio"
							id="gongbu" name="isgongbu" value="1"><label
							style="color: red;display: inline;" for="gongbu">公布</label> <span>
								&emsp;选择范围： <select id="fanwei" name="fanwei"
								style="width: 100px;">
									<c:if test="${yijian.nimingbiaoji==0}">
								...
								value="${yijian.yijianid}"> </span>&emsp;&emsp;<br>
							<button type="button" name="action" class="btn btn-primary"
								value="提交" onclick="return subchuli()">提交</span>
					</form>
				</div>
				<br> <br>
			</div>
