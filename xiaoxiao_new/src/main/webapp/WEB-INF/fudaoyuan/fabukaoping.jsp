				...
				<c:when test="${not empty fangAns}">
					<table
						...
						<tr>
							...
							<th style="text-align: center;"><strong>发布</strong></th>
						</tr>
						<c:forEach items="${fangAns}" var="fangan">
							<tr style="text-align: center;">
								...
								<td style="text-align: center;">
										<button class="btn btn-success" value="详情" onclick="toContentPage('fangAnDetail_fdy?id=${fangan.fanganid}')">详情</button></td>
								<td style="text-align: center;">
									<button class="btn btn-warning" value="修改" onclick="toContentPage('xiuGai_fdy?id=${fangan.fanganid}')">修改</button></td>
								<td style="text-align: center; width: 20%;"><button
										class="btn btn-default" value="发布" onclick="toContentPage('fabu_fdy?id=${fangan.fanganid}')">发布</button></td>
							</tr>
						</c:forEach>
					</table>
				</c:when>
