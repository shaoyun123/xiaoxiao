			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-top">
				<div class="container-fluid">
					<div class="navbar-header">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="addhuodong_jiaoshi" ><span title="新增活动" class="glyphicon glyphicon-plus" style="padding-top:20px;font-size:18px"></span></a>
					</div>
								...
								<table class="table table-striped">
									...
									<tbody>
											<tr>
												...
												<td>
													<c:if test="${huodong.zhuangtai==0}"><a  href="canyuhuodong_jiaoshi?id=${huodong.huodongid}"><input type="button" value="参与"></a></c:if>
													<c:if test="${huodong.zhuangtai==1}">——</c:if>
													<c:if test="${huodong.zhuangtai==2}">——</c:if>
												</td>
												<td>
													<a href="chakancanyuren_jiaoshi?id=${huodong.huodongid}"><input type="button" value="查看"></a>
												</td>
												<td>
													<c:if test="${xiugai==1 }">
													   <a href="xiugaihuodong_jiaoshi?id=${huodong.huodongid}"><input type="button" value="修改"></a>
													</c:if>
												</td>
												<td>
												<c:if test="${huodong.zhuangtai==0}"><a href="delhuodong_jiaoshi?id=${huodong.huodongid}"><input type="button" value="拒绝"></a></c:if>
													<c:if test="${huodong.zhuangtai==1}"><a href="delhuodong_jiaoshi?id=${huodong.huodongid}"><input type="button" value="拒绝"></a></c:if>
													<c:if test="${huodong.zhuangtai==2}">——</c:if>
												</td>
