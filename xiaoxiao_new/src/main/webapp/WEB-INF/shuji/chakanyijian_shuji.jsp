...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
	...
	<div class="box-header">
		<h2>
			<i class="icon-align-justify"></i><span class="break"></span>查看意见
		</h2>
	</div>
				...
				<div class="card" style="background-color:#ffffff;"><br>
					...
					<div style="width:88%;margin-left:40px">
						...
						<c:forEach items="${pinglun}" var="PingLun">
							<c:if test="${PingLun.jiaoshiid==user.yonghuid && PingLun.beihuifuxueshengid==null && PingLun.beihuifujiaoshiid==null}">
								<h5 style="color:blue;margin-left:10px;">${PingLun.shijian}</h5>
								<span>${PingLun.huifuneirong}</span><br>
							</c:if>
						</c:forEach>
					</div><br><br>
				</div>
